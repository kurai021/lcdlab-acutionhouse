...
export async function getNFTMetadata(
  ...
  try {
    ...
    let metadata: any = {
        ...
        description: "That night as the Boku frothed, it was corrupted and frothed a terrible blood red color and its usual fizz and bubble sounds were replaced with the screams of thousands of vengeful spirits...",
        image: "https://resources.boryokudragonz.io/img/red_boku.gif",
        attributes: [
          {
          "trait_type": "Color",
          "value": "Blood Red"
        ...
        properties: {
          files: [
            {
            "uri": "https://resources.boryokudragonz.io/img/red_boku.gif",
            "type": "image/gif"
            }
          ],
          category: "image",
